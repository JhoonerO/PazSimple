      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoSection}>
          ...
          <Text style={styles.countText}>
            {likedStories.length} historia{likedStories.length !== 1 ? "s" : ""}
          </Text>
        </View>
        ...
        {likedStories.length > 0 ? (
          <>
            ...
            {likedStories.map((story) => (
              <TouchableOpacity key={story.id} style={styles.storyCard} onPress={() => handleStoryPress(story)}>
                {/* Imagen de la historia */}
                <Image source={story.image} style={styles.storyImage} resizeMode="cover" />
